        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            {admin ? (
              ...
              <Link
                to="/login"
                className="hidden sm:flex items-center space-x-2 px-4 py-2 rounded-2xl text-xs font-medium text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition-all"
              >
          ...
          {admin ? (
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-slate-800">
              <Link
                to="/login"
                onClick={() => setMobileMenuOpen(false)}
                className="block w-full text-center px-4 py-3 rounded-xl text-sm font-normal text-slate-400 dark:text-slate-500"
              >
                Login
              </Link>
            </div>
